    ...
    @volt('pages.moodboards')
        <div>
            <div class="flex flex-wrap items-end justify-between gap-4">
                ...
                <flux:modal.trigger name="create-moodboard">
                        ...
                        @foreach ($this->moodboards as $moodboard)
                            ...
                            >
                                <a
                                    ...
                                    wire:navigate
                                >
                                    @if ($moodboard->coverPhoto && $moodboard->coverPhoto->isImage())
                                        <img
                                            src="{{ $moodboard->coverPhoto->small_thumbnail_url }}"
                                            alt="{{ $moodboard->title }}"
                                            ...
                                            height="267"
                                        />
                                    @elseif ($moodboard->firstImage())
                                        <img
                                            src="{{ $moodboard->firstImage()->small_thumbnail_url }}"
                                            alt="{{ $moodboard->title }}"
                                            class="aspect-3/2 w-full rounded-t-lg object-cover transition-transform duration-300 group-hover:scale-105"
                                            loading="lazy"
                                            width="400"
                                    ...
                                    <div class="p-4">
                                        ...
                                        @if ($moodboard->description)
                                            <flux:text variant="subtle" size="sm" class="mb-2 line-clamp-2">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <flux:text variant="subtle" size="sm">
                                                {{ $moodboard->photosCount() }} {{ __('photos') }}
                                            </flux:text>
